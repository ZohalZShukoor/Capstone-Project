...
public class CommonUtility extends BaseSetup {
	...
	public void clear (WebElement element, String value){
		      WebElement searchInput = getDriver().findElement(By.name(value));
	...
	public boolean validateToastMessageAppearance(String message){
	    return waitTillPresence((toastMessage.format(message)));
	}

	private boolean waitTillPresence(String string) {
